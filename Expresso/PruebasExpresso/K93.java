...
public class K93 {
    ...
    public void k93() {
        ...
        ViewInteraction editText4 = onView(
                withId(R.id.account_password));
        editText4.perform(scrollTo(), replaceText("pruebas2017*"), closeSoftKeyboard());
        ...
        ViewInteraction button3 = onView(
                allOf(withId(android.R.id.button1), withText("Edit details"), isDisplayed()));
        ...
        editText7.perform(scrollTo(), replaceText("Miso"), closeSoftKeyboard());
        ...
        ViewInteraction recipientSelectView2 = onView(
                allOf(withId(R.id.to),
                        withParent(withId(R.id.to_wrapper))));
        recipientSelectView2.perform(scrollTo(), replaceText("jorgedavidrg@gmail.com"), closeSoftKeyboard());


        ViewInteraction editText8 = onView(
                withId(R.id.subject));
        editText8.perform(scrollTo(), replaceText("Prueba"), closeSoftKeyboard());

        ViewInteraction eolConvertingEditText = onView(
                withId(R.id.message_content));
        eolConvertingEditText.perform(scrollTo(), click());

        ViewInteraction eolConvertingEditText2 = onView(
                withId(R.id.message_content));
        eolConvertingEditText2.perform(scrollTo(), click());

        ViewInteraction eolConvertingEditText3 = onView(
                withId(R.id.message_content));
        eolConvertingEditText3.perform(scrollTo(), click());

        ViewInteraction eolConvertingEditText4 = onView(
                withId(R.id.message_content));
        eolConvertingEditText4.perform(scrollTo(), replaceText("Prueba"), closeSoftKeyboard());
